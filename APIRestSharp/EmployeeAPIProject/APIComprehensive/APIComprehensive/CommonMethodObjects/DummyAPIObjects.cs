...
namespace APIComprehensive.CommonMethodObjects
{
    public class DummyAPIObjects
    {
        ...
        {
            string filePath = @"C:\Users\Jesus\Desktop\ASPProject\SeleniumPTI\APIComprehensive\APIComprehensive\EmployeeId.txt";
